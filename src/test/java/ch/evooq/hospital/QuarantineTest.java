...
public class QuarantineTest {
    ...
    public void testCorrectPatientList() throws InvalidInputException {
        quarantine = new Quarantine(Some("F,H,H,T"), Some(""), ctx);
        assertThat(quarantine.cure(), equalTo("F:1,H:2,D:0,T:1,X:0"));
    }
    ...
    public void testIncorrectPatientList() throws InvalidInputException {
        quarantine = new Quarantine(Some("F,H,X,Y,Z"), Some(""), ctx);
        assertThat(quarantine.cure(), equalTo("F:1,H:1,D:0,T:0,X:1"));
    }
